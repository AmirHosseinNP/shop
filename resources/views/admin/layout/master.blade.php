                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu animated flipInY">
                            <!-- User image -->
                            <li class="user-header bg-img" style="background-image: url(src="/admin/images/user-info.jpg)" data-overlay="3">
                    ...
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu animated fadeInDown">
                            ...
                            <li class="header">
                                <div class="bg-img text-white p-20" style="background-image: url(src="/admin/images/user-info.jpg)" data-overlay="5">
                                    <div class="flexbox">
                                        <div>
        ...
        <section class="content">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="row">
                        <div class="col-12">
                            <div class="box bg-img box-inverse" style="background-image: url(src="/admin/images/gallery/full/10.jpg);" data-overlay="7">
