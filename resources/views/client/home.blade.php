                        ...
                        @foreach($featuredCategory->getAllSubcategoryProducts() as $product)
                            <div class="product-thumb clearfix">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="price">
                                        <span
                                            class="price-new">{{ number_format($product->cost_with_discount) }} تومان </span> <br>
                    ...
                    @foreach($categories as $category)
                        ...
                        <div class="owl-carousel latest_category_carousel">
                            @foreach($category->getAllSubcategoryProducts() as $product)
                                <div class="product-thumb">
                                    <div class="image"><a href="{{ route('client.products.show', $product) }}"><img
                                                src="{{ str_replace('public', '/storage', $product->image) }}"
                                                alt="{{ $product->name }}"
                                                title="کرم مو آقایان" class="img-responsive"/></a></div>
                                    <div class="caption">
                                        ...
                                        <p class="price">
                                            ...
                                            @if($product->has_discount)
                                                <span
                                                    class="price-old">{{ number_format($product->cost) }} تومان </span>
                                                <span class="saving">-{{ $product->discount_value }}%</span>
                                            @endif
                                        </p>
                                        <div class="rating"><span class="fa fa-stack"><i
